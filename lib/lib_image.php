...
class cls_image
{
    ...
    var $bgcolor     = '';
    var $type_maping = array(1 => 'image/gif', 2 => 'image/jpeg', 3 => 'image/png', 4 => 'image/JPG');
    ...
    function upload_image($upload, $dir = '', $img_name = '')
    {
        ...
        if (!file_exists($dir))
        {
            ...
            {
                /* 创建目录失败 */
                $this->error_msg = sprintf("创建%s目录失败", $dir);
        ...
        {
            $this->error_msg = sprintf('无法保存文件', $upload['name']);
