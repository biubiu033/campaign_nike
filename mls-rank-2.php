...
$query = "SELECT id,full_name,team_name,teamId,mile,marathon_project FROM dtc_taskone_marathon ORDER by mile DESC";
$result = mysql_query($query,$conn);
while ($row = mysql_fetch_assoc($result)){
    $type = $row['marathon_project'];
    switch ($type){
        case 5:
            $five[] = $row;
            break;
...
?>
    ...
    <head>
        ...
        <style>
            ...
            .rank .box .list {
                display: block;
                width: 24.3rem;
                padding: 7rem 2.0rem 0.5rem 0.8rem;
                box-sizing: border-box;
                height: 36.6rem;
                margin-top: -6.9rem;
                overflow-y: scroll;
    ...
    <body>
    <div class="wrap rank">
<!--        <div class="tab-title" style="text-align: right;height: 2rem" data-t="2">
        </div>
        <div class="tab-title active-1" style="text-align: right;height:2rem" data-t="1"></div>-->
        <div class="box">

                <div class="tab_1" >
                    <div class="item_1 clb brl active" data-mid="1">5K
                        </div>
                    <div class="item_1 lh2" data-mid="2">10K
                        </div>
                    <div class="item_1" data-mid="3">半马
                        <p class="tab_1-p"> HALF MARATHON</p></div>
                    <div class="item_1 brr" data-mid="4">全马
                        <p class="tab_1-p"> FULL MARATHON</p></div>
                </div>

            <div class="tab-title active-1" data-to="1">
                <div class="tab " >
                    ...
                    <div class="item" style="width: 9rem">里程<br><span class="__span">KM</span></div>
                </div>
                <ul class="list" >
                    <?php $count = 0;
                    foreach ($five as $item_row) {
                            $count = $count + 1;
                            ?>
                            <li class="list-li" id="<?php echo $item_row['id'] ?>">
                                ...
                                <div class="_div"><span class="_span"><?php
                                    ...
                                    <p class="distance"><?php echo round($item_row['mile']); ?>
                                    </p></div>
    ...
    <script>
        $(".tab_1 .item_1").on("click", function () {
            ...
            $('[data-to=' + $(this).attr("data-mid") + ']').addClass("active-1").siblings(".tab-title").removeClass("active-1");
        });
